...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.example.android.hellotoast.extra.HelloCount";
    ...
    */
    ...
    public void launchSecondActivity(View view) {
        ...
        String showCount = mShowCount.getText().toString();
        intent.putExtra(EXTRA_MESSAGE, showCount);
