package com.example.a107ab0008_hw10_2;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>, AdapterView.OnItemSelectedListener {
    ...
    public void getSourceCode(View view) {
        ...
        if (URLUtil.isValidUrl(mSpinnerValue + queryString) && networkInfo != null && networkInfo.isConnected() && (queryString.length() != 0)){
            ...
            else if(!URLUtil.isValidUrl(mSpinnerValue + queryString)){
